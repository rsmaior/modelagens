...
with open(os.path.join(os.path.dirname(__file__),'master_file_300_dsgtools_v3.json'), 'r', encoding='utf-8') as f:
...
with open(os.path.join(os.path.dirname(__file__),'masterfile_300_dsgtools_v4.json'), 'w', encoding='utf-8') as g:
